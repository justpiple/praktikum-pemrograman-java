...
public class Main {
    ...
    public static void main(String[] args) {
        ...
        Perpustakaan perpus = new Perpustakaan("Perpustakaan Pusat UB", "Gedung A, Lantai 2");
        ...
        Buku t3 = new Buku("Life 3.0: Being Human in the Age of Artificial Intelligence", 2017, "9781101946596");
        ...
        Buku f1 = new Buku("Filosofi Teras: Filsafat Yunani-Romawi Kuno untuk Mental Tangguh Masa Kini", 2018, "978-623-346-931-9");
        ...
        Kategori sejarah = new Kategori("Sejarah", "Buku seputar sejarah Indonesia dan sejarah peradaban dunia");

        Buku s1 = new Buku("Sejarah Indonesia: Dinamika Bangsa dalam Arus Global (10 jilid)", 2025, "ISBN berbeda per jilid");
        ...
        Buku s3 = new Buku("Perjuangan Mempertahankan Kemerdekaan Indonesia", 2017, "ISBN ada di katalog Deepublish");
        ...
        Kategori psikologi = new Kategori("Psikologi", "Buku seputar psikologi, kesehatan mental, dan pengembangan diri");

        Buku p1 = new Buku("Pulih dari Trauma: Berkenalan dengan Trauma dan Proses Penyembuhan yang Penuh Harapan", 2025, "ISBN tercantum di katalog Gramedia");
        ...
        Buku p4 = new Buku("How to be Alone and Not Feel Lonely: Seni Berdamai dengan Rasa Sepi", 2024, "978-602-955-282-9");
        p4.tambahPenulis(new Penulis("Tristanti Wahyuni", "Indonesia"));

        psikologi.tambahBuku(p1, p2, p3, p4);
        perpus.tambahKategori(psikologi);

        Kategori politik = new Kategori("Politik", "Buku seputar politik, demokrasi, hukum, dan tata kelola pemerintahan");

        Buku po1 = new Buku("Literasi Politik dan Konsolidasi Demokrasi di Indonesia", 2024, "ISBN tercantum di katalog UIN");
        ...
        Kategori fiksi = new Kategori("Fiksi", "Buku novel dan karya sastra fiksi dari penulis Indonesia dan luar negeri");
